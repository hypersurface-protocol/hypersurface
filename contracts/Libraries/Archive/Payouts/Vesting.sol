...
/// Vesting contract fors tokens.
library HyperDAOVesting {
    ...
    function setHypercore(bytes calldata hypercoreData) public nonReentrant virtual {
        (address[] memory accounts, uint256[] memory amounts, uint256[] memory startTimes, uint256[] memory endTimes) 
            = abi.decode(hypercoreData, (address[], uint256[], uint256[], uint256[]));
